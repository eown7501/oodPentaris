...
/**
 * 이 ViewPausePanelSolo는 AIGame진행 도중 esc를 눌렀을 시 Pause화면의 Panel을 구성하고 보여주는
 * 클래스입니다.
 * 
 * @author 신승현
 * 
 */
public class ViewPausePanelAI extends JPanel implements IViewPanel {
	 ...
	 */
	public ViewPausePanelAI(ViewTotalFrame totalFrame) {
