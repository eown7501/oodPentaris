...
/**
 * 이 ViewAIRankingResetPanel 클래스는 AIRanking을 초기화하는 화면의 Panel을 구성하고 보여주는 클래스입니다.
 * 
 * @author 이은경
 */
public class ViewAIRankingResetPanel extends JPanel {
	...
	/** ActionLister를 구현합니다. 
	 * 
	 * @return ActionListener ActionListener를 반환합니다. 
	 */
