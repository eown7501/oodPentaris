...
public class BlockZ extends Block {
	...
	public void initShape1P() {
		...
		coord1P = new Point[] { new Point(0, 0), new Point(0, -1), new Point(-1, 1), new Point(1, -1), new Point(0, 1) };
		tempCoord1P = new Point[] { new Point(0, 0), new Point(0, -1), new Point(-1, 1), new Point(1, -1), new Point(0, 1) };
	}
	...
	public void initShape2P() {
		...
		color = new Color(255, 110, 0);
		coord2P = new Point[] { new Point(0, 0), new Point(0, -1), new Point(-1, 1), new Point(1, -1), new Point(0, 1) };
		tempCoord2P = new Point[] { new Point(0, 0), new Point(0, -1), new Point(-1, 1), new Point(1, -1), new Point(0, 1) };
	}
	...
	public void initShapeSolo() {
		...
		color = new Color(255, 110, 0);
		coordSolo = new Point[] { new Point(0, 0), new Point(0, -1), new Point(-1, 1), new Point(1, -1), new Point(0, 1) };
		tempCoordSolo = new Point[] { new Point(0, 0), new Point(0, -1), new Point(-1, 1), new Point(1, -1), new Point(0, 1) };
	}
