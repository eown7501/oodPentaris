...
/**
 * 이 BlockL 클래스는 Block을 상속하고 있으며, L Block을 구현한 Class 입니다.
 * 
 * @author 곽소정
 *
 */
public class BlockL extends Block {
	...
	/**
	 * 1P GameBoard 위에 L Block을 생성합니다.
	 * 
	 * @param gameBoard
